...
print(f"{format_timestamp()}DARKROOM: Successfully injected {len(image_files)} images into {html_file}", file=sys.stderr)

# Find available port
port = find_available_port()
print(f"{format_timestamp()}DARKROOM: Starting Web Server on Port {port}", file=sys.stderr)
...
print(f"{format_timestamp()}DARKROOM: Server Ready: Listening on port {port}", file=sys.stderr)
